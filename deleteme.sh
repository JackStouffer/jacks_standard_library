./embed --var-name=dynamic_header_template tools/templates/dynamic_hash_map_header.txt > tools/templates/dynamic_hash_map_header.h
./embed --var-name=dynamic_source_template tools/templates/dynamic_hash_map_source.txt > tools/templates/dynamic_hash_map_source.h
./embed --var-name=dynamic_header_template tools/templates/dynamic_array_header.txt > tools/templates/dynamic_array_header.h
./embed --var-name=dynamic_source_template tools/templates/dynamic_array_source.txt > tools/templates/dynamic_array_source.h
...
clang \
    ...
    -pedantic -o tests/bin/generate_hash_map \
...
clang \
    ...
    -Wpointer-arith -Wassign-enum -Wswitch-enum -Wimplicit-fallthrough \
    -Wnull-dereference -Wmissing-prototypes -Wundef \
    -pedantic -o tests/bin/generate_array \
    -Isrc/ tools/generate_array.c

./tests/bin/generate_array \
    --name DynamicInt32Array \
    --function-prefix dynamic_int32_array \
    --value-type int32_t \
    --dynamic \
    --header \
    --add-header ../tests/test_hash_map_types.h > tests/hash_maps/dynamic_int32_array.h
./tests/bin/generate_array \
    --name DynamicInt32Array \
    --function-prefix dynamic_int32_array \
    --value-type int32_t \
    --dynamic \
    --source \
    --add-header ../tests/hash_maps/dynamic_int32_array.h \
    --add-header ../tests/test_hash_map_types.h > tests/hash_maps/dynamic_int32_array.c
